<template>
  <div>
    <h3 class="text-3xl">Create or Choose an Item to add to Claim</h3>
    <div class="flex flex-col m-auto w-64">
      <input
        ...
        v-model="albumName"
      />
      <button class="btn-blue mb-4" @click="createAlbum()">Create Item</button>
    </div>
    <div class="text-red-500">{{ error }}</div>
    <hr />
    <h5 class="mt-4 text-2xl">List Of Items</h5>
